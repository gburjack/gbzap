...
export const followUpQueue = new Bull('gbzap:follow-up', redisUrl, { defaultJobOptions });
export const reminderQueue = new Bull('gbzap:reminders', redisUrl, { defaultJobOptions });
export const messageQueue  = new Bull('gbzap:messages',  redisUrl, {
  defaultJobOptions,
  limiter: {
    max:      1,
    duration: 1200,
...
export const warmupQueue = new Bull('gbzap:warmup', redisUrl, { defaultJobOptions });
